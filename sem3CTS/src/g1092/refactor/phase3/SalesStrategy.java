	...
	public float ComputeFinalPrice(
			ProductType productType, float initialPrice, int yearsSinceRegistration) throws InvalidValueException
	  {
	    ...
	    case NEW:
	    	...
	    	break;
	    case DISCOUNTED:
		      finalPrice = getPriceWithDiscount(initialPrice,ProductType.DISCOUNTED.getDisocunt(),fidelityDiscount); 
		      break;
	    case LIMITED_STOCK:
		      finalPrice =getPriceWithDiscount(initialPrice,ProductType.LIMITED_STOCK.getDisocunt(),fidelityDiscount); 
		      break;
	    case LEGACY:
		      finalPrice =getPriceWithDiscount(initialPrice,ProductType.LEGACY.getDisocunt(),fidelityDiscount); 
		      break;
		default:
